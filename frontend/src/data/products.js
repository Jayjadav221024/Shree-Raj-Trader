// AUTO-GENERATED from the live product pages (13 products / 5 categories).
// `longDescription` and `liveSpecs` are verbatim from https://shreerajtraders.in.
//
// KNOWN LIVE BUG: /products/meniscus-top/ uses FRP-Cable-Tray.jpg as its product
// photo, which shows a cable tray rather than a grating. We fall back to the FRP
// grating category image until the client supplies a correct Meniscus Top photo.
// TODO(client): supply real photos for Meniscus Top and for the ROBUS / QUBO
// gearbox variants (currently both use the shared gear-box image).
...
const CATEGORIES = [
  {
    ...
    "href": "/products_category/switchgears/",
    ...
    "items": [
      {
        ...
        "href": "/products/siemens-switchgear-low-voltage-power-distribution-product/",
        ...
        "liveSpecs": [
          "Contactors:",
          "Size: S00 to S12 Operational current: 7A to 500A Switching Device:",
          "Size: S6 to S12 22 kW to 250 kW"
        ],
        ...
        // TODO: confirm with client (live site is self-contradictory)
        // TODO: applications not sourced from live site — confirm with client
        "applications": "Direct-On-Line Starters, Motor Control Centers, Industrial Control Panels"
      },
      {
        "slug": "low-voltage-control-product",
        "href": "/products/low-voltage-control-product/",
        ...
        "liveSpecs": [
          "MCCB: Rated current: 16A to 1250A Breaking capacity: 16KA to 55KA ACB: Rated current: 630A to 6300A Short circuit breaking capacity: 150KA Rated up to 55°C Control Switch: Frame size: 100 to 630A"
        ],
      ...
      },
      {
        ...
        "liveSpecs": [
          ...
          "Voltage: 240/415V",
          "Frequency: 50-60Hz ISI marking: CM/L no. 2255548 Rated current: 0.5A to 63A 1, 2, 3, 4 pole available"
        ],
        "name": "MCB",
        "brand": "Siemens",
        "imageKey": "mcb",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "href": "/products/crompton-greaves-motor/",
      ...
      },
      {
        ...
        "href": "/products/hindustan-electric-motor/",
  ...
  },
  {
    ...
    "href": "/products_category/frp-gratings/",
  ...
  },
  {
    ...
    "href": "/products_category/frp-cable-tray/",
    ...
    "items": [
      {
        ...
        "href": "/products/ladder-type-cable-tray/",
      ...
      },
      {
        ...
        "href": "/products/perforated-cable-tray/",
...
/** Categories with every image resolved to a local .webp (src + width + height). */
export const productCategories = CATEGORIES.map((cat) => ({
  ...cat,
  image: images.products[cat.imageKey],
  items: cat.items.map((item) => ({
    ...item,
    image: images.products[item.imageKey]
  }))
}));

/** Flat list of all 13 products, each carrying its category metadata. */
