  ...
  return (
    <div className="flex items-center gap-3">
      <button
        ...
        className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-adm-primary focus-visible:ring-offset-2 focus-visible:ring-offset-adm-surface ${value ? 'bg-adm-primary' : 'bg-adm-line-strong'
          }`}
      >
        <span
